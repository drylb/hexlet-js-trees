...
import { downcaseFileNames, downcaseFileNames1 } from '../src/downcaseFileName';
...
describe('should1', () => {
  test('be immutable', () => {
    ...
    downcaseFileNames1(tree);

    expect(tree).toEqual(original);
  });

  test('downcase file names1', () => {
    const tree = mkdir('/', [
      mkdir('eTc', [
        mkdir('NgiNx'),
        mkdir('CONSUL', [
    ...
    const actual = downcaseFileNames1(tree);
